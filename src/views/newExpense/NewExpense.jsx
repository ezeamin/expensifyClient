        ...
        <div className='text-light'>
            ...
            <div className="newExpense__optionsBox">
                <div className="newExpense__optionsBox__group">
                    <a href='/newExpense/income' className="newExpense__optionsBox__button newExpense__optionsBox__button--ingreso">
                        <i className="fa-solid fa-arrow-up fa-2x"></i>
                    </a>
                    <p className='mb-0 mt-3 descripciones'>Ingreso</p>
                </div>
                <div className="newExpense__optionsBox__group">
                    <a href='/newExpense/expense' className="newExpense__optionsBox__button newExpense__optionsBox__button--gasto">
